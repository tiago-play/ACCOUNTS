...
function addAmount(accountName, amount) {
    ...
    console.log(
        chalk.green(
            `Foi depositado o valor de R$${amount} na conta ${accountName}, saldo total = R$${accountData.balance}!`
        )
    )
}
...
function withdraw() {
    ...
    .then((answer) => {
        ...
        inquirer.prompt([
            {
                name: 'amount',
                messagem: 'Quanto você deseja sacar?'
            }
        ])
        .then((answer) => {
...
function removeAmount(accountName, amount) {
    ...
    if(accountData.balance < amount) {
        console.log(chalk.bgRed.black('Vaor indisponível'))
        return withdraw()
    }
